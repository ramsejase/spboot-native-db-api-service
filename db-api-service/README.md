...
### Spring AOT + GraalVM + Native + WebFlux + Docker

A typical example for the SpringBoot Application running in a native environment
...
```
$ docker run --rm db-api-service:0.0.1-SNAPSHOT
```
